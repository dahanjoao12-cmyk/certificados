...
insert into certificates (company_id, type, model, valid_from, valid_to, is_current, origin)
select id, 'e-cnpj', 'A1', current_date - interval '1 year', current_date + interval '351 days', true, 'manual' from c1;
...
insert into certificates (company_id, type, model, valid_from, valid_to, is_current, origin)
select id, 'e-cnpj', 'A1', current_date - interval '1 year', current_date + interval '15 days', true, 'manual' from c2;
...
insert into certificates (company_id, type, model, valid_from, valid_to, is_current, origin)
select id, 'e-cnpj', 'A3', current_date - interval '1 year', current_date, true, 'manual' from c3;
...
insert into certificates (company_id, type, model, valid_from, valid_to, is_current, origin)
select id, 'e-cnpj', 'A1', current_date - interval '1 year', current_date - interval '20 days', true, 'manual' from c4;
...
insert into certificates (company_id, type, model, valid_from, valid_to, archived, is_current, origin)
select id, 'e-cnpj', 'A1', current_date - interval '2 years', current_date - interval '1 year', true, false, 'manual' from c5;
...
insert into certificates (company_id, type, model, valid_from, valid_to, is_current, origin, created_at)
select id, 'e-cnpj', 'A1', current_date - interval '3 years', current_date - interval '2 years', false, 'manual', now() - interval '3 years' from c6
union all
select id, 'e-cnpj', 'A1', current_date - interval '2 years', current_date - interval '1 year', false, 'manual', now() - interval '2 years' from c6
union all
select id, 'e-cnpj', 'A1', current_date - interval '1 year', current_date + interval '200 days', true, 'manual', now() - interval '1 year' from c6;
